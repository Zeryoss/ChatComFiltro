...
def enviar_mensagem():
    ...
    if mensagem.strip():
        ...
        # Opcional: exibir uma mensagem para o usuário indicando que a mensagem está vazia
...
def receber_mensagens():
    ...
    try:
        while cliente_socket:
            ...
            if not msg:
                break
            exibir_mensagem(msg) # A mensagem já virá formatada do servidor com o nome
...
def conectar_servidor(nome_usuario):
    ...
    try:
        ...
        cliente_socket.connect(('localhost', 100))
